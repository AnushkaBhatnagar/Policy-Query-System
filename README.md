...
Analyze course transcripts for import eligibility. Uses Claude Vision to process transcript images or text, checking against Columbia's import requirements. Returns detailed eligibility analysis with reasoning.
